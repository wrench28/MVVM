...
//            employeeViewModel.manipulateButtonText = "Insert"
    ...
    private fun insertEmployee()
    {
        ...
        if(dataValidation(name,dept)){
            ...
            Toast.makeText(this,employeeViewModel.insertionSuccessMessage,Toast.LENGTH_SHORT).show()
    ...
    private fun updateEmployee(id:Int)
    {
        ...
        if(dataValidation(name,dept)){
            ...
            Toast.makeText(this,employeeViewModel.updationSuccessMessage,Toast.LENGTH_SHORT).show()
            startActivity(Intent(this,MainActivity::class.java))
            finish()
        }
        else
